...
//           onReturnToPoll={returnToPoll}
//           isPollInProgress={pollStarted}
//           currentIndex={currentSkillIndex}
//         />
//       )}
//     </div>
...
//             className="absolute top-4 right-4 py-2 px-4 bg-white text-gray-700 rounded-lg shadow-xs transition-all duration-300 hover:bg-gray-100 hover:shadow-2xl active:scale-95 text-sm font-medium z-10 cursor-pointer"
//           >
//             See Results
//           </button>
//         )}
...
//               <button
//                 onClick={() =>
//                   currentIndex < totalSkills - 1 && onNavigate("next")
//                 }
//                 className={`text-gray-400 text-lg md:text-xl transition-all duration-300 ${
...
//                 className="flex-1 py-2 md:py-3 px-3 bg-[#677C9B] text-white rounded-lg shadow-md transition-all duration-300 hover:bg-[#4a6081] hover:shadow-[0_8px_20px_rgba(0,0,0,0.3)] active:scale-95 cursor-pointer font-semibold"
//               >
//                 Self Taught
//               </button>
//               <button
//                 onClick={() => onVote(currentSkill, "schoolTaught")}
//                 className="flex-1 py-2 md:py-3 px-3 bg-[#A99F94] text-white rounded-lg shadow-md transition-all duration-300 hover:bg-[#bba081] hover:shadow-[0_8px_20px_rgba(0,0,0,0.3)] active:scale-95 cursor-pointer font-semibold"
//               >
//                 School Taught
//               </button>
//             </div>
...
//                 How much of what we know comes from school and how much from
//                 ourselves?
...
//         {/* Added Return to Poll button with proper positioning */}
...
//           ></div>
//           <span className="absolute right-1 top-1/2 -translate-y-1/2 text-md font-semibold opacity-0 group-hover:opacity-100 transition-opacity">
//             {selfPercent}%
//           </span>
//         </div>
//         <div className="bg-gray-200 rounded-lg overflow-hidden relative group">
...
export default function App() {
  ...
  const viewResultsFromCompletion = () => {
    setIsTransitioning(true);
    setTimeout(() => {
    ...
    <div className="w-full h-screen flex flex-col overflow-hidden">
      {submissionComplete ? (
        <CompletionScreen 
          bgColor={bgBlue}
          isTransitioning={isTransitioning}
          onViewResults={viewResultsFromCompletion}
        />
      ) : !pollCompleted ? (
        <VotingInterface
          pollStarted={pollStarted}
...
function IPadInterface({
  ...
  console.log(onReturnToPoll, isPollInProgress, "ppppppppppppppppppppppp")
...
function CompletionScreen({ bgColor, isTransitioning, onViewResults }) {
  return (
    <div
      className="h-full w-full flex flex-col justify-center items-center"
      style={{
    ...
    >
      <div className="flex flex-col justify-center items-center h-full w-full p-6 md:p-10 lg:p-16">
        ...
        >
          <h2 className="text-center font-bold text-2xl mb-6">Submission complete!</h2>
